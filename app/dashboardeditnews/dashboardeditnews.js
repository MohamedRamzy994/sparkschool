(function () {
    ...
    EditNewsController.$inject = ['AddNewNewsFactory', 'toaster', 'ActiveNewsCategoriesFactory', '$route', '$http', "appsettings", "EditNewsFactory", "$routeParams"];

    function EditNewsController(AddNewNewsFactory, toaster, ActiveNewsCategoriesFactory, $route, $http, appsettings, EditNewsFactory, $routeParams) {
        var vm = this;
        ...
        if ($routeParams.News_Id != null) {
            ...
            var model=new EditNewsFactory();
                model.News_Id=$routeParams.News_Id;
            EditNewsFactory.Get(model, function (response) {
...
(function () {
    ...
    angular
        .module('DashboardApp')
        .factory('EditNewsFactory', EditNewsFactory)

    EditNewsFactory.$inject = ['$resource', 'appsettings'];

    function EditNewsFactory($resource, appsettings) {
        ...
        return $resource(appsettings.serverPath + "/api/News/EditNews", {
            News_Id: "@News_Id"
        }, {
