(function () {
    ...
    NewJobsController.$inject = ['AddNewJobsFactory', 'toaster', 'ActiveJobsCategoriesFactory', '$route','$http',"appsettings"];
    function NewJobsController(AddNewJobsFactory, toaster, ActiveJobsCategoriesFactory, $route,$http,appsettings) {
        var vm = this;
