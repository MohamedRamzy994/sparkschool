(function () {
    ...
    angular
        .module('DashboardApp')
        .controller('NewProgrameCourseController', NewCourseController);

    NewCourseController.$inject = ['AddNewCourseFactory', 'toaster', 'ActiveCoursesCategoriesFactory', '$route', '$http', "appsettings","$routeParams","GetProgrameNameFactory"];

    function NewCourseController(AddNewCourseFactory, toaster, ActiveCoursesCategoriesFactory, $route, $http, appsettings,$routeParams,GetProgrameNameFactory) {
        var vm = this;
        ...
        vm.Submit = function () {
            ...
            if ($routeParams.Programe_Id != null) {
                ...
                URI.Programe_Id=vm.Programe_Id;
                ...
                $http({
                    url: appsettings.serverPath + "/api/Programes/NewProgrameCourse",
                    method: 'POST',
                    headers: {
